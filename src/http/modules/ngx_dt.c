...
enum listen {DT_LISTEN_TYPE, DT_LISTEN_BACKLOG, DT_LISTEN_RCVBUF,
	DT_LISTEN_SNDBUF, DT_LISTEN_KEEPIDLE, DT_LISTEN_KEEPINTVL,
	DT_LISTEN_KEEPCNT, DT_LISTEN_OPEN, DT_LISTEN_REMAIN,
	...
	DT_LISTEN_ADD_DEFERRED, DT_LISTEN_SETFIB, DT_LISTEN_FASTOPEN,
	DT_LISTEN_TIMESTAMP, DT_LISTEN_MAX};
    ...
    struct timespec *when, DBSC_DIGEST_CTX *ctx)
{
	...
	columns[DT_LISTEN_KEEPIDLE] = new_dbsc_int64(listen->keepidle, ctx);
	columns[DT_LISTEN_KEEPINTVL] = new_dbsc_int64(listen->keepintvl, ctx);
	columns[DT_LISTEN_KEEPCNT] = new_dbsc_int64(listen->keepcnt, ctx);
	...
	columns[DT_LISTEN_SETFIB] = new_dbsc_int64(listen->setfib, ctx);
...
enum conn {DT_CONN_TYPE, DT_CONN_BUFFERED, DT_CONN_LOG_ERROR,
	...
	DT_CONN_PIPELINE, DT_CONN_IDLE, DT_CONN_REUSABLE,
	DT_CONN_CLOSE, DT_CONN_SHARED, DT_CONN_SENDFILE,
	DT_CONN_SNDLOWAT, DT_CONN_TCP_NODELAY, DT_CONN_TCP_NOPUSH,
	DT_CONN_NEED_LAST_BUF, DT_CONN_NEED_FLUSH_BUF, DT_CONN_BUSY_COUNT,
	DT_CONN_TIMESTAMP, DT_CONN_MAX};
    ...
    struct timespec *when, DBSC_DIGEST_CTX *ctx)
{
	...
	columns[DT_CONN_BUSY_COUNT] = new_dbsc_int64(conn->busy_count, ctx);
...
ngx_dt_enable(ngx_conf_t *cf, ngx_command_t *cmf, void *conf)
{
	...
	"CREATE TABLE x(DT_LISTEN_TYPE INTEGER, DT_LISTEN_BACKLOG INTEGER, DT_LISTEN_RCVBUF INTEGER, DT_LISTEN_SNDBUF INTEGER, DT_LISTEN_KEEPIDLE INTEGER, DT_LISTEN_KEEPINTVL INTEGER, DT_LISTEN_KEEPCNT INTEGER, DT_LISTEN_OPEN INTEGER, DT_LISTEN_REMAIN INTEGER, DT_LISTEN_IGNORE INTEGER, DT_LISTEN_BOUND INTEGER, DT_LISTEN_INHERITED INTEGER, DT_LISTEN_NONBLOCKING_ACCEPT INTEGER, DT_LISTEN_LISTEN INTEGER, DT_LISTEN_NONBLOCKING INTEGER, DT_LISTEN_SHARED INTEGER, DT_LISTEN_ADDR_NTOP INTEGER, DT_LISTEN_WILDCARD INTEGER, DT_LISTEN_IPV6ONLY INTEGER, DT_LISTEN_REUSEPORT INTEGER, DT_LISTEN_ADD_REUSEPORT INTEGER, DT_LISTEN_KEEPALIVE INTEGER, DT_LISTEN_QUIC INTEGER, DT_LISTEN_DEFERRED_ACCEPT INTEGER, DT_LISTEN_DELETE_DEFERRED INTEGER, DT_LISTEN_ADD_DEFERRED INTEGER, DT_LISTEN_SETFIB INTEGER, DT_LISTEN_FASTOPEN INTEGER, timestamp INTEGER)",
